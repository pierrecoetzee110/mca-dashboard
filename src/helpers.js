...
export const statusLabel = { complete: "Complete", backlog: "Not Started" };
export const statusColor = { complete: "var(--green)", backlog: "var(--dim)" };
export const statusBg    = { complete: "var(--green-dim)", backlog: "#f0f2f5" };
